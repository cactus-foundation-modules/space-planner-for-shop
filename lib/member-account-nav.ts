...
//
// "My spaces" rather than "My layouts", because a space is the thing a person
// remembers measuring and a layout is one of several attempts at filling it.
//
...
// somebody with no spaces should be sent anyway.
